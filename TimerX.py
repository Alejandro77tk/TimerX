...
# Carga el sonido
# Cargar los sonidos
click_sonido = pygame.mixer.Sound(str(resource_path("assets/click.mp3")))
tick_sonido = pygame.mixer.Sound(str(resource_path("assets/tick_2.wav")))
alarma_sonido = pygame.mixer.Sound(str(resource_path("assets/alarma_tiempo.mp3")))
...
window.iconbitmap(str(resource_path("assets/x_1_.ico")))
window.title("TimerX")
# Fondo de la ventana
canvas = Canvas(
    window,
...
image_image_4 = PhotoImage (
    file=str(resource_path("assets/image_11.png")))
...
image_image_3 = PhotoImage (
    file=str(resource_path("assets/image_10.png")))
...
image_image_1 = PhotoImage(
    file=str(resource_path("assets/se_termina_tiempo.png")))
...
crono.place(x=600, y=260)#, anchor="nw"
...
def cuenta_atras():
    ...
    if tiempo_restante > 0 and cuenta_atras_activa:
        ...
        if tiempo_restante == 0:
            ...
            crono.place_forget()
            crono_acabado.pack()
            crono_acabado.place(x=600, y=260)
...
imgSONIDO = Image.open(str(resource_path("assets/button_2_SONIDO.png"))).convert("RGBA")
photoSONIDO = ImageTk.PhotoImage(imgSONIDO)

img_NO_SONIDO = Image.open(str(resource_path("assets/button_1_NO_SONIDO.png"))).convert("RGBA")
...
img = Image.open(str(resource_path("assets/button_1.png"))).convert("RGBA")
...
img1 = Image.open(str(resource_path("assets/button_2.png"))).convert("RGBA")
...
img2 = Image.open(str(resource_path("assets/button_3.png"))).convert("RGBA")
...
img3 = Image.open(str(resource_path("assets/button_4.png"))).convert("RGBA")
...
img4 = Image.open(str(resource_path("assets/button_5.png"))).convert("RGBA")
...
img5 = Image.open(str(resource_path("assets/button_6.png"))).convert("RGBA")
...
img6 = Image.open(str(resource_path("assets/button_7.png"))).convert("RGBA")
